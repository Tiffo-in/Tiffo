        ...
        <View style={{ padding: 10 }}>
          ...
          <View style={{ flexDirection: 'row', alignItems: 'center', gap: 6, marginTop: 3 }}>
            <View style={{ flexDirection: 'row', alignItems: 'center', gap: 3 }}>
              <Ionicons name="star" size={10} color="#FF7A00" />
          ...
          >
            <Text style={{ fontSize: 11, fontWeight: '800', color: C.textPrimary }}>
              From <Text style={{ color: '#FF7A00' }}>₹{priceVal}</Text>/day
            </Text>
            <View
              style={{
                backgroundColor: '#22c55e',
        ...
        {CAT_ICONS.map((cat) => (
          ...
          >
            <View
              style={[
                S.catIconWrap,
                activeCat === cat.label && { borderColor: '#FF7A00', borderWidth: 2.5 },
              ]}
            >
              {cat.image ? (
            ...
            <Text
              style={[
                S.catIconLabel,
                activeCat === cat.label && { color: '#FF7A00', fontWeight: '700' },
              ]}
            >
              {cat.label}
            </Text>
      ...
      <View style={S.topHeader}>
        <View style={{ flex: 1 }}>
          ...
          <View style={{ flexDirection: 'row', alignItems: 'center', gap: 6 }}>
            ...
            <Text style={[S.pageTitle, { color: '#FF7A00' }]}>Meals</Text>
        ...
        <View style={{ alignItems: 'flex-end', gap: 8 }}>
          <TouchableOpacity style={S.locPill}>
            <Ionicons name="location-sharp" size={12} color="#FF7A00" />
...
const createStyles = (C: ColorScheme) =>
  StyleSheet.create({
    ...
    viewAllTxt: { fontSize: 12, fontWeight: '700', color: '#FF7A00' },
    ...
    resultPrice: { fontSize: 14, fontWeight: '700', color: '#FF7A00', marginTop: 4 },
  });
