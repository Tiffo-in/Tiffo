                ...
                <View style={S.resultBody}>
                  <View style={{ flexDirection: 'row', alignItems: 'flex-start' }}>
                    <View style={[S.vegIndicator, { borderColor: item.isVeg ? C.veg : C.nonVeg }]}>
                      <View
                        style={[S.vegDot, { backgroundColor: item.isVeg ? C.veg : C.nonVeg }]}
                      />
                    </View>
                  ...
                  {item.rating && (
                    <View style={{ flexDirection: 'row', alignItems: 'center', marginTop: 4 }}>
                      <Text style={{ fontSize: 11, color: C.secondary, fontWeight: '700' }}>
                        ★ {item.rating.average.toFixed(1)}
                      </Text>
                      {item.rating.count > 0 && (
                        <Text style={{ fontSize: 10, color: C.textTertiary, marginLeft: 4 }}>
                          ({item.rating.count})
                        </Text>
                      )}
                    </View>
