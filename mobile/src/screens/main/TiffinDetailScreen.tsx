...
export default function TiffinDetailScreen({ route, navigation }: Props) {
  ...
  const computedPrice =
    typeof tiffin.price === 'object'
      ? (tiffin.price as any)[selectedPlan] ||
        (tiffin.price as any).daily * (PLANS[selectedPlan]?.days || 1)
        ...
        <View style={S.heroWrap}>
          ...
          <View style={S.heroRating}>
            ...
            {(tiffin.rating?.count ?? 0) > 0 && (
              <Text style={{ color: 'rgba(255,255,255,0.8)', fontSize: 11, marginLeft: 4 }}>
                ({tiffin.rating!.count})
              </Text>
            )}
          </View>
            ...
            {plans.map((plan) => {
              ...
              return (
                ...
                >
                  ...
                  <Text style={[S.planName, active && S.planNameActive]}>
                  ...
                  {info?.discount ? (
                    <View style={S.discountPill}>
                      <Text style={S.discountTxt}>{info.discount}</Text>
                    </View>
                  ) : null}
                </TouchableOpacity>
              );
