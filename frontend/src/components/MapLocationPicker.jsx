    ...
    if (navigator.geolocation) {
      navigator.geolocation.getCurrentPosition(
        ...
        (error) => {
          ...
          setIsSearching(false);
          alert(
            'Unable to get your current location. Please click on the map to set your business location.'
          );
        },
        {
    ...
    <div className="space-y-4">
      ...
      <div className="flex flex-wrap gap-3">
        <motion.button
          ...
          className="flex items-center px-4 py-2 bg-maroon-600 text-on-brand rounded-lg hover:bg-maroon-700 transition-colors disabled:bg-gray-400"
      ...
      <div
        className="border-2 border-gray-200 rounded-lg overflow-hidden shadow-card"
        style={{ height: '400px' }}
      >
        <MapContainer
