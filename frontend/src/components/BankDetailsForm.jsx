    ...
    >
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
        <p className="text-sm text-blue-800">
          <strong>Important:</strong> This information is required to receive payments from
          customers. All data is encrypted and securely stored.
        </p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div>
          ...
          />
          <p className="text-xs text-gray-500 mt-1">If you have GST registration</p>
        </div>
      ...
      <div className="mt-6 bg-gray-50 border border-gray-200 rounded-lg p-4">
        <p className="text-xs text-gray-600">
          🔒 <strong>Security:</strong> Your bank details are encrypted and stored securely. We
          never store your full account number in plain text.
        </p>
      </div>
    </motion.div>
  );
