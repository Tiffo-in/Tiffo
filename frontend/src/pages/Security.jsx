      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <div className="mb-10">
            ...
            <h1 className="text-4xl font-black text-neutral-900 mb-3">How We Keep You Safe</h1>
            <p className="text-neutral-500 text-lg">
              Your security is our top priority. Here's how Tiffo protects your data and your
              transactions.
            </p>
          </div>

          <div className="bg-white rounded-2xl shadow-card border border-neutral-100 p-8 space-y-2">
            <Section icon="🔒" title="Data Encryption">
              <p>
                All data in transit is protected with TLS 1.3 (HTTPS). Sensitive data at rest is
                encrypted using AES-256.
              </p>
              <p>
                Your payment details are never stored on our servers — they are handled exclusively
                by Razorpay, a PCI DSS Level 1 certified payment processor.
              </p>
            </Section>
            ...
            <Section icon="🛡️" title="Account Security">
              <ul className="list-disc list-inside space-y-1">
                ...
                <li>
                  Authentication uses secure{' '}
                  <code className="text-sm bg-neutral-100 px-1 py-0.5 rounded">httpOnly</code>{' '}
                  cookies — not localStorage — to prevent XSS token theft
                </li>
                <li>
                  CSRF protection via the double-submit cookie pattern on all mutating requests
                </li>
                <li>
                  Rate limiting on login and registration endpoints (10 requests / 15 minutes per
                  IP)
                </li>
                <li>NoSQL injection prevention via input sanitization on all API endpoints</li>
                <li>
                  XSS protection via server-side HTML sanitization on all user-supplied strings
                </li>
              </ul>
            </Section>
            ...
            <Section icon="💳" title="Payment Security">
              <p>
                All payments are processed through <strong>Razorpay</strong>, India's leading PCI
                DSS compliant payment gateway.
              </p>
            ...
            <Section icon="📱" title="API Security">
              <ul className="list-disc list-inside space-y-1">
                ...
                <li>
                  Role-based access control: customers, partners, and admins have separate
                  permission scopes
                </li>
            ...
            <Section icon="🚨" title="Responsible Disclosure">
              ...
              <p className="mt-2">
                Please do not publicly disclose a vulnerability until we have had a chance to
                address it.
              </p>
            </Section>
            ...
            <Section icon="📆" title="Last Updated">
              <p>
                This Security page was last updated on <strong>April 2026</strong>.
              </p>
            </Section>
          </div>
