        ...
        >
          <div className="mb-10 text-center">
            <h1 className="text-4xl md:text-5xl font-black text-neutral-900 mb-4">
              Partner <span className="text-primary-600">Guidelines</span>
            </h1>
          ...
          <div className="space-y-8">
            <div className="flex gap-4">
              <div className="mt-1 shrink-0 bg-primary-100 p-3 rounded-full">
            ...
            <div className="flex gap-4">
              <div className="mt-1 shrink-0 bg-secondary-100 p-3 rounded-full">
                <ShieldCheckIcon className="w-6 h-6 text-secondary-600" />
              </div>
              <div>
                <h3 className="text-xl font-bold text-neutral-900 mb-2">2. Hygiene Standards</h3>
                <p className="text-neutral-600 leading-relaxed">
            ...
            <div className="flex gap-4">
              <div className="mt-1 shrink-0 bg-pink-100 p-3 rounded-full">
                <HandThumbUpIcon className="w-6 h-6 text-pink-600" />
              </div>
              <div>
                <h3 className="text-xl font-bold text-neutral-900 mb-2">3. Timely Delivery</h3>
                <p className="text-neutral-600 leading-relaxed">
