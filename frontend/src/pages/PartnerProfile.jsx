                ...
                if (res.data.success && res.data.data) {
                    ...
                    setProfileData({
                        ...
                        businessHours: {
                            ...
                            workingDays: p.businessHours?.workingDays || ['Monday','Tuesday','Wednesday','Thursday','Friday','Saturday']
                        },
                ...
                >
                    ...
                    <div className="flex items-center justify-between mb-8">
                        <h1 className="text-4xl font-extrabold text-gray-900 flex items-center">
                            ...
                            <span className="bg-gradient-to-r from-maroon-600 via-maroon-700 to-maroon-800 dark:from-maroon-400 dark:via-maroon-500 dark:to-maroon-600 bg-clip-text text-transparent">Partner Profile</span>
                        </h1>
                    ...
                    <div className="mb-8 border-b-2 border-gray-200 relative">
                        <nav className="-mb-0.5 flex space-x-8 relative">
                            <button
                                ...
                                className={`relative py-4 px-1 font-bold text-base transition-colors duration-300 ${activeTab === 'profile'
                                        ? 'text-maroon-600'
                            ...
                            <button
                                ...
                                className={`relative py-4 px-1 font-bold text-base transition-colors duration-300 ${activeTab === 'payment'
                                        ? 'text-maroon-600'
                                        : 'text-gray-500 hover:text-gray-700'
                                    }`}
                            >
                    ...
                    {activeTab === 'profile' ? (
                        <>
                            ...
                            <div className="glass-card mb-8 p-8 shadow-premium">
                                ...
                                {!isEditing && profileData.logo && (
                                    <div className="mb-6 w-24 h-24 rounded-2xl overflow-hidden shadow-sm border border-neutral-200">
                                        <img src={profileData.logo} alt="Business Logo" className="w-full h-full object-cover" />
                                    </div>
                                )}
                                ...
                                {isEditing && (
                                    <div className="mb-6 bg-gradient-to-r from-yellow-50 to-amber-50 dark:from-yellow-900/30 dark:to-amber-900/30 border-l-4 border-yellow-400 rounded-lg p-4">
                                        <p className="text-sm text-yellow-900 font-medium">
                                            <strong>⚠️ Important:</strong> Setting your exact location helps customers find you when searching for nearby tiffin services.
                                        </p>
                                    </div>
                                )}
                                        ...
                                        <div className="flex flex-wrap gap-2">
                                            {weekDays.map(day => (
                                                <button
                                                    ...
                                                    disabled={!isEditing}
                                                    className={`px-3 py-1 rounded-lg text-sm font-medium transition-colors ${profileData.businessHours.workingDays.includes(day)
                            ...
                            <div className="glass-card p-8 shadow-premium">
                                ...
                                <div>
                                    <label className="block text-sm font-medium text-gray-700 mb-2">
                                        Delivery Radius: <span className="text-maroon-600 font-bold">{profileData.deliveryRadius} km</span>
                                    </label>
                                    <input
                                        type="range"
                                        min="1"
                        ...
                        <BankDetailsForm onSuccess={() => alert('Bank details saved! You can now receive payments.')} />
                    )}
                </motion.div>
            </div>
        </div>
