      ...
      <AuthBrandPanel
        ...
        heading={
          <>
            Reset your
            <br />
            <span className="text-primary-400">Tiffo password.</span>
          </>
        }
        subheading="Don't worry, it happens to the best of us. Enter your email and we'll send you a secure reset link."
        benefitsTitle="What happens next"
        benefits={[
          ...
          <div className="bg-white rounded-3xl shadow-card-hover p-8 md:p-10">
            {!sent ? (
              <>
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <p className="text-center text-neutral-600 text-sm">
                    ...
                    <Link
                      to="/login"
                      className="font-semibold text-brand-ink hover:text-primary-600 transition-colors"
                    >
                      Sign in
                    </Link>
                  </p>
              ...
              >
                ...
                <p className="text-neutral-600 mb-2">We've sent a password reset link to:</p>
                <p className="font-semibold text-primary-600 mb-6">{email}</p>
                <p className="text-sm text-neutral-500 mb-8">
                  Didn't receive the email? Check your spam folder or{' '}
                  <button
                    onClick={() => setSent(false)}
                    className="text-brand-ink font-semibold hover:text-primary-600"
                  >
                    try again
                  </button>
                  .
