  ...
  const features = [
    {
      ...
      description: 'Discover homemade tiffin services in your area effortlessly. Explore menus and read reviews.',
      emoji: '🔍'
    },
    {
      icon: ClockIcon,
      title: 'Flexible Plans',
      description: 'Choose from daily, weekly, or monthly subscription options that fit your lifestyle.',
      emoji: '⏰'
    },
    {
      icon: ShieldCheckIcon,
      title: 'Verified Partners',
      description: 'All tiffin providers are strictly verified for food quality, taste, and kitchen hygiene.',
      emoji: '✅'
    },
    {
      icon: TruckIcon,
      title: 'Timely Delivery',
      description: 'Enjoy hot, fresh meals delivered right to your doorstep exactly when you need them.',
      emoji: '🚚'
    }
  ];
  ...
  return (
    <div className="min-h-screen relative bg-neutral-50 dark:bg-neutral-950 font-sans selection:bg-primary-200 selection:text-primary-900 overflow-hidden">
      <Helmet>
        ...
        <meta name="description" content="Discover and subscribe to authentic homemade tiffin services near you. Fresh, healthy, and hygienic meals delivered daily." />
      </Helmet>
      ...
      <section className="relative min-h-[95vh] flex flex-col justify-center pt-32 pb-20 overflow-hidden">
        ...
        <div className="absolute inset-0 opacity-[0.03] dark:opacity-10 pointer-events-none -z-10" style={{ backgroundImage: 'radial-gradient(circle at 2px 2px, currentColor 1px, transparent 0)', backgroundSize: '40px 40px' }} />
        
        <motion.div style={{ y: yHero }} className="absolute right-10 top-20 w-[500px] h-[500px] opacity-30 dark:opacity-20 blur-[120px] pointer-events-none -z-10">
          <div className="w-full h-full bg-gradient-to-br from-primary-400 to-secondary-400 rounded-full" />
        </motion.div>
        
        <motion.div style={{ y: yHero, scale: -1 }} className="absolute left-10 bottom-20 w-[400px] h-[400px] opacity-20 dark:opacity-10 blur-[100px] pointer-events-none -z-10">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full relative z-10 flex flex-col items-center">
          ...
          >
            <h1 className="text-5xl md:text-7xl lg:text-8xl font-black text-neutral-900 dark:text-white leading-[1.05] tracking-tight mb-8">
              Homemade Tiffins <br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary-500 to-secondary-500">Delivered Fresh.</span>
            </h1>

            <p className="text-xl md:text-2xl text-neutral-600 dark:text-neutral-400 mb-12 leading-relaxed max-w-2xl font-medium">
              Discover authentic homemade meals from local tiffin providers. Fresh, healthy, and delivered to your door.
            </p>

            <div className="flex flex-col sm:flex-row gap-5 justify-center items-center w-full max-w-lg">
              <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }} className="w-full sm:w-auto">
                <Link to="/tiffins" className="flex items-center justify-center gap-3 w-full px-8 py-4 bg-neutral-900 dark:bg-white text-white dark:text-neutral-900 hover:bg-neutral-800 dark:hover:bg-neutral-100 rounded-2xl font-black shadow-2xl shadow-neutral-900/20 dark:shadow-white/10 transition-all duration-300 text-lg">
                  <span>🍱</span>
              ...
              <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }} className="w-full sm:w-auto">
                {user && user.role !== 'partner' ? (
                  <Link to="/support?subject=partner" className="flex items-center justify-center gap-3 w-full px-8 py-4 bg-white/50 dark:bg-neutral-900/50 backdrop-blur-md text-neutral-900 dark:text-white border-2 border-neutral-200 dark:border-neutral-800 hover:border-primary-500 dark:hover:border-primary-500 rounded-2xl font-bold transition-all duration-300 text-lg">
                    <span>👨‍🍳</span>
                    <span>Become a Partner</span>
                  </Link>
                ) : !user ? (
                  <Link to="/register?role=partner" className="flex items-center justify-center gap-3 w-full px-8 py-4 bg-white/50 dark:bg-neutral-900/50 backdrop-blur-md text-neutral-900 dark:text-white border-2 border-neutral-200 dark:border-neutral-800 hover:border-primary-500 dark:hover:border-primary-500 rounded-2xl font-bold transition-all duration-300 text-lg">
                    <span>👨‍🍳</span>
                    <span>Become a Partner</span>
                  </Link>
                ) : (
                  <Link to="/partner/dashboard" className="flex items-center justify-center gap-3 w-full px-8 py-4 bg-white/50 dark:bg-neutral-900/50 backdrop-blur-md text-neutral-900 dark:text-white border-2 border-neutral-200 dark:border-neutral-800 hover:border-primary-500 dark:hover:border-primary-500 rounded-2xl font-bold transition-all duration-300 text-lg">
                    <span>👨‍🍳</span>
            ...
            <div className="grid grid-cols-3 gap-8 mx-auto">
              {heroItems.map((item, index) => (
                ...
                >
                  ...
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent opacity-80 group-hover:opacity-100 transition-opacity duration-500" aria-hidden="true" />
      ...
      <section className="py-32 relative overflow-hidden bg-white dark:bg-neutral-950">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-20">
            ...
            >
              Why Choose <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary-500 to-secondary-500">Tiffo</span>?
            </motion.h2>
            <motion.p 
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
            ...
            >
              Experience the best of authentic homemade food with our carefully crafted delivery ecosystem.
            </motion.p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-6">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <Link to="/tiffins" className="group inline-flex items-center gap-2 text-lg font-bold text-primary-600 hover:text-primary-700 dark:text-primary-400 dark:hover:text-primary-300 transition-colors bg-primary-50 dark:bg-primary-900/20 px-6 py-3 rounded-xl">
                View All Catalog
            ...
            <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-16">
              <div className="max-w-xl text-center md:text-left">
                ...
                <h2 className="text-5xl md:text-7xl font-black text-white mb-6 leading-[1.1] tracking-tight">
                  Tiffo in your <br/>pocket.
                </h2>
                <p className="text-xl md:text-2xl text-neutral-300 mb-12 font-medium leading-relaxed">
                  Track orders in real-time, manage subscriptions instantly, and discover new meals on the go.
                </p>
                ...
                {isWaitlistSubmitted ? (
                  ...
                  >
                    ...
                    <p className="text-neutral-300 font-medium">We'll let you know when the app drops.</p>
                  </motion.div>
                ) : (
              ...
              <div className="hidden md:flex relative flex-shrink-0">
                ...
                >
                  <div className="absolute top-0 inset-x-0 h-7 bg-neutral-800 rounded-b-3xl mx-24 z-20" /> {/* Notch */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-12 mb-16">
            <div className="col-span-2 lg:col-span-2">
              <Link to="/" className="inline-block text-4xl font-black tracking-tight text-neutral-900 dark:text-white mb-6">
                <span className="text-4xl mr-2">🍱</span>Tiffo<span className="text-primary-500">.</span>
              </Link>
              <p className="text-neutral-500 dark:text-neutral-400 max-w-sm mb-8 leading-relaxed font-medium">
                Reimagining daily dining by connecting you with passionate home chefs. Authentic, hygienic, and delivered with care.
              </p>
              <div className="flex gap-4">
                <a href="#" className="w-12 h-12 bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 rounded-full flex items-center justify-center text-neutral-600 dark:text-neutral-400 hover:text-white hover:bg-neutral-900 dark:hover:bg-primary-600 hover:border-transparent transition-all shadow-sm">
                  𝕏
                </a>
                <a href="#" className="w-12 h-12 bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 rounded-full flex items-center justify-center text-neutral-600 dark:text-neutral-400 hover:text-white hover:bg-pink-600 hover:border-transparent transition-all shadow-sm">
                  IG
                </a>
              </div>
            </div>
            ...
            <div>
              <h4 className="text-neutral-900 dark:text-white font-black text-lg mb-6 tracking-wide">Company</h4>
              <ul className="space-y-4">
                <li><Link to="/about" className="text-neutral-500 dark:text-neutral-400 hover:text-primary-600 dark:hover:text-primary-400 font-medium transition-colors">About Us</Link></li>
                <li><Link to="/blog" className="text-neutral-500 dark:text-neutral-400 hover:text-primary-600 dark:hover:text-primary-400 font-medium transition-colors">Blog</Link></li>
                <li><Link to="/careers" className="text-neutral-500 dark:text-neutral-400 hover:text-primary-600 dark:hover:text-primary-400 font-medium transition-colors">Careers</Link></li>
              </ul>
            </div>

            <div>
              <h4 className="text-neutral-900 dark:text-white font-black text-lg mb-6 tracking-wide">Support</h4>
              <ul className="space-y-4">
                <li><Link to="/support" className="text-neutral-500 dark:text-neutral-400 hover:text-primary-600 dark:hover:text-primary-400 font-medium transition-colors">Help Center</Link></li>
                <li><Link to="/terms" className="text-neutral-500 dark:text-neutral-400 hover:text-primary-600 dark:hover:text-primary-400 font-medium transition-colors">Terms of Service</Link></li>
                <li><Link to="/privacy" className="text-neutral-500 dark:text-neutral-400 hover:text-primary-600 dark:hover:text-primary-400 font-medium transition-colors">Privacy Policy</Link></li>
              </ul>
            </div>

            <div>
              <h4 className="text-neutral-900 dark:text-white font-black text-lg mb-6 tracking-wide">Partner</h4>
              <ul className="space-y-4">
                <li><Link to="/register?role=partner" className="text-neutral-500 dark:text-neutral-400 hover:text-primary-600 dark:hover:text-primary-400 font-medium transition-colors">Become a Chef</Link></li>
                <li><Link to="/partner-guidelines" className="text-neutral-500 dark:text-neutral-400 hover:text-primary-600 dark:hover:text-primary-400 font-medium transition-colors">Guidelines</Link></li>
              </ul>
            </div>
          </div>
