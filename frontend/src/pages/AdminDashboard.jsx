...
const AdminDashboard = () => {
  ...
  if (loading) {
    return (
      ...
      >
        <div
          className="animate-spin w-12 h-12 border-4 border-primary-500 border-t-transparent rounded-full"
          aria-hidden="true"
        />
      </div>
    );
          ...
          >
            ...
            <div className="flex items-center gap-4">
              ...
              <div
                ...
                aria-live="polite"
                aria-label={
                  isConnected ? 'Real-time connection active' : 'Real-time connection offline'
                }
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="font-semibold text-amber-900">
                  {stats.pendingPartners} pending partner application
                  {stats.pendingPartners !== 1 ? 's' : ''}
                </p>
