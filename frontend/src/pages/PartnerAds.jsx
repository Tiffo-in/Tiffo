      ...
      <div className="bg-gradient-to-r from-fuchsia-700 via-rose-600 to-orange-500 pt-[110px] pb-32 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <button
            ...
            className="text-white/80 hover:text-white mb-6 font-medium"
          >
            ← Back to Dashboard
          </button>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-1 space-y-6">
              <motion.div
                ...
                className="bg-white dark:bg-neutral-900 rounded-3xl p-6 shadow-xl border border-neutral-100 dark:border-neutral-800"
              >
              ...
              <motion.div
                ...
                className="bg-gradient-to-br from-neutral-900 to-black rounded-3xl p-6 shadow-xl relative overflow-hidden"
              >
