...
const TiffinDetail = () => {
  ...
  const heroImage =
    tiffin.images?.[0] || foodImages[Math.abs(tiffin._id?.charCodeAt(0) % foodImages.length) || 0];
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-neutral-950">
      <Helmet>
        <title>
          {tiffin ? `${tiffin.title} | Tiffo Homemade Tiffins` : 'Loading Tiffin Details | Tiffo'}
        </title>
        <meta
          name="description"
          content={
            tiffin
              ? `Order ${tiffin.title} by ${tiffin.partner?.businessName || 'local chef'}. Authentic ${tiffin.cuisine} ${tiffin.mealType} starting at ₹${tiffin.price?.daily || ''}/day.`
              : 'Discover authentic homemade tiffin services near you.'
          }
        />
            ...
            <div className="bg-white dark:bg-neutral-900 rounded-2xl p-5 shadow-sm border border-gray-100 dark:border-neutral-800">
              ...
              <div className="grid grid-cols-4 gap-3">
                {[
                  {
                    label: 'Calories',
                    value: tiffin.nutritionInfo.calories,
                    unit: 'kcal',
                    color: 'text-orange-500',
                  },
                  {
                    label: 'Protein',
                    value: tiffin.nutritionInfo.protein,
                    unit: 'g',
                    color: 'text-blue-500',
                  },
                  {
                    label: 'Carbs',
                    value: tiffin.nutritionInfo.carbs,
                    unit: 'g',
                    color: 'text-yellow-500',
                  },
                  {
                    label: 'Fat',
                    value: tiffin.nutritionInfo.fat,
                    unit: 'g',
                    color: 'text-red-500',
                  },
                ].map((n) =>
                  n.value ? (
                    <div
                      key={n.label}
                      className="text-center p-3 rounded-xl bg-gray-50 dark:bg-neutral-800"
                    >
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="text-right">
                          ...
                          {disc > 0 && (
                            <p className="text-xs text-green-600 font-semibold">{disc}% off</p>
                          )}
                        </div>
                      </button>
                    );
            ...
            >
              ...
              <div className="flex items-center justify-between p-5 border-b dark:border-neutral-700">
                <div className="flex items-center gap-2">
                  ...
                  <span className="bg-maroon-600 text-white text-xs px-2 py-0.5 rounded-full">
                    1
                  </span>
                </div>
              ...
              <div className="flex-1 overflow-y-auto p-5 space-y-4">
                ...
                <div className="bg-gray-50 dark:bg-neutral-800 rounded-2xl p-4 border border-gray-200 dark:border-neutral-700">
                  <div className="flex items-start gap-3">
                    <div className="bg-maroon-100 dark:bg-maroon-900/40 rounded-xl p-3 text-2xl">
                      🍱
                    </div>
                ...
                <div className="bg-white dark:bg-neutral-800 rounded-2xl p-4 border border-gray-200 dark:border-neutral-700 space-y-2 text-sm">
                  ...
                  {cartItem.discountPercent > 0 && (
                    <div className="flex justify-between text-green-600">
                      <span>
                        {cartItem.discountLabel || `${cartItem.discountPercent}% Discount`}
                      </span>
