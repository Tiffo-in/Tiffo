                    ...
                    {[
                        {
                            ...
                            change: `+${stats.overview.customerGrowth}%`,
                            trend: 'up',
                            icon: UserGroupIcon,
                        ...
                        >
                            <div className="flex items-start justify-between">
                                ...
                                <span className={`flex items-center gap-1 text-sm font-medium ${stat.trend === 'up' ? 'text-green-600' : 'text-amber-600'
                                    }`}>
                                    {stat.trend === 'up' ? (
                    ...
                    >
                        ...
                        <div className="space-y-3">
                            {stats.topCustomers.map((customer, index) => (
                                <div key={customer._id} className="flex items-center gap-4 p-3 bg-neutral-50 rounded-xl">
                        ...
                        >
                            ...
                            <div className="flex gap-4">
                                {[
                                    ...
                                    { plan: 'Weekly', percent: stats.subscriptionTrends.weekly, color: 'bg-purple-500' },
                                    { plan: 'Monthly', percent: stats.subscriptionTrends.monthly, color: 'bg-green-500' }
                                ].map((item) => (
