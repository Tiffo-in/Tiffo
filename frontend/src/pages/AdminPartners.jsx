...
const AdminPartners = () => {
    ...
    const handleApprove = async (partnerId) => {
        try {
            const response = await api.patch(`/admin/partners/${partnerId}/status`, { status: 'approved' });
    ...
    const handleReject = async (partnerId) => {
        try {
            const response = await api.patch(`/admin/partners/${partnerId}/status`, { status: 'rejected', reason: 'Admin rejected application' });
            if (response.data.success) {
            ...
            <div className="max-w-7xl mx-auto px-4 py-8">
                ...
                >
                    <button
                        ...
                        className={`flex-1 py-3 px-6 rounded-xl font-medium transition-all flex items-center justify-center gap-2 ${activeTab === 'pending'
                    ...
                    <button
                        ...
                        className={`flex-1 py-3 px-6 rounded-xl font-medium transition-all flex items-center justify-center gap-2 ${activeTab === 'verified'
                                        ...
                                        <div className="p-6">
                                            <div className="flex items-start justify-between">
                                                <div className="flex items-center gap-4">
                                                    ...
                                                    <div>
                                                        <h3 className="text-lg font-bold text-neutral-900">{partner.businessName || partner.name || 'Unknown Partner'}</h3>
                                            ...
                                            <div className="mt-4 flex items-center gap-2">
                                                ...
                                                {partner.documents?.map((doc, i) => (
                                                    <span key={i} className="px-2 py-1 bg-neutral-100 text-neutral-600 rounded-lg text-sm">
                                                        {doc}
                                                    </span>
                                                ))}
                                            </div>
                                    ...
                                    <div className="p-6">
                                        <div className="flex items-start gap-4">
                                            ...
                                            <div className="flex-1">
                                                <div className="flex items-center gap-2">
                                                    <h3 className="font-bold text-neutral-900">{partner.businessName || partner.name || 'Unknown Partner'}</h3>
                                        ...
                                        <div className="grid grid-cols-2 gap-4 mt-4">
                                            <div className="bg-neutral-50 rounded-xl p-3 text-center">
                                                <p className="text-2xl font-bold text-neutral-900">{partner.totalOrders || 0}</p>
                                                <p className="text-sm text-neutral-500">Orders</p>
                                            </div>
                                            <div className="bg-green-50 rounded-xl p-3 text-center">
                                                <p className="text-2xl font-bold text-green-600">{formatCurrency(partner.totalEarnings || 0)}</p>
