        ...
        setTimeout(() => {
            if (action === 'delete') {
                ...
                setUsers(prev => prev.map(u =>
                    selectedIds.includes(u._id) ? { ...u, isVerified: true } : u
                ));
            } else if (action === 'ban') {
                setUsers(prev => prev.map(u =>
                    selectedIds.includes(u._id) ? { ...u, isActive: false } : u
                ));
            }
            setSelectedIds([]);
            setBulkAction(null);
                        ...
                        <div className="flex gap-2">
                            {['all', 'user', 'partner'].map(role => (
                                <button
                                    ...
                                    className={`px-4 py-2 rounded-xl font-medium transition-all ${roleFilter === role
                                            ...
                                            <td className="py-4 px-6">
                                                {user.role === 'user' ? (
                                                    <div className="text-sm">
                                                        <div className="text-neutral-600">{user.subscriptions || 0} subscriptions</div>
                                                        <div className="font-medium text-green-600">₹{user.totalSpent || 0}</div>
                                                    </div>
                                                ) : (
                            ...
                            <div className="p-6 space-y-4">
                                <div className="grid grid-cols-2 gap-4">
                                    ...
                                    <div className="bg-neutral-50 rounded-xl p-4">
                                        ...
                                        <p className={`font-bold ${selectedUser.isVerified ? 'text-green-600' : 'text-amber-600'}`}>
                                            {selectedUser.isVerified ? 'Verified' : 'Pending'}
                                        </p>
                                    </div>
                                </div>
                                <div className="flex gap-3">
                                    <button className="flex-1 py-3 bg-red-100 text-red-700 rounded-xl font-medium hover:bg-red-200 transition-colors">
                                        Ban User
                                    </button>
