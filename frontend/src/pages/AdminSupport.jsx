...
const AdminSupport = () => {
  ...
  const getStatusIcon = (status) => {
    switch (status) {
      ...
      case 'closed':
        return <ArchiveBoxIcon className="w-4 h-4 mr-1" />;
      default:
        return <ClockIcon className="w-4 h-4 mr-1" />;
    }
  };
  ...
  return (
    <div className="min-h-screen bg-gray-50 pt-[110px] pb-8">
      <div className="max-w-7xl mx-auto px-4">
        ...
        {/* Filters */}
        <div className="bg-white p-4 rounded-xl shadow-card mb-6 flex gap-2">
                ...
                <tbody>
                  {tickets.map((ticket, i) => (
                    ...
                    >
                      ...
                      <td className="px-6 py-4">
                        <div
                          className={`flex items-center justify-center px-3 py-1 rounded-full border text-xs font-semibold capitalize ${getStatusStyle(ticket.status)}`}
                        >
