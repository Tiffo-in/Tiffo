...
const LoginScreen = ({ navigation }: Props) => {
  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      Alert.alert('Login Failed', err.message || err.response?.data?.message || 'Something went wrong.');
    } finally {
      setLoading(false);
    }
  };
        ...
        <View style={styles.formCard}>
          ...
          <View style={styles.noteBox}>
            <Text style={styles.noteText}>
              This app is exclusively for registered Tiffo kitchen partners.
              To join as a partner, visit our website.
            </Text>
          </View>
        </View>
      </ScrollView>
...
const styles = StyleSheet.create({
  ...
  logoCircle: {
    ...
    marginBottom: 16,
    shadowColor: '#F59E0B', shadowOpacity: 0.4, shadowRadius: 16,
  ...
  input: {
    ...
    borderRadius: 12, padding: 14, fontSize: 15, color: '#F8FAFC',
  },
  loginBtn: {
  ...
  noteBox: {
    ...
    marginTop: 20, borderWidth: 1, borderColor: '#1E3A5F',
  },
